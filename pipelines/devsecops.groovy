                ...
                stage('eShop Source'){ 
                    steps {
                        ...
                        dir("sample_projects/eShopOnWeb"){
                            withSonarQubeEnv('sonarqube.local.net'){sh "dotnet-sonarscanner begin /d:sonar.branch.name=${GIT_BRANCH} /d:sonar.pullrequest.key=${gitlabMergeRequestId} /k:root_devsecops-demo_AXcajgPuJYkemuZ5HaAk"}
